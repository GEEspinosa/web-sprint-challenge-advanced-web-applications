...
export default function ArticleForm(props) {
  ...
  const {postArticle, setCurrentArticleId, currentArticle, updateArticle} = props
  ...
  return (
    ...
    <form id="form" onSubmit={onSubmit}>
      ...
      <div className="button-group">
        ...
        {
          currentArticle? <button onClick={() => setCurrentArticleId(null)}>Cancel edit</button>: null
        }   
      </div>
    </form>
  )
